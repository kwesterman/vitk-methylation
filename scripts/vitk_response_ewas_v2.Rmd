...
data.frame(parameter=c("age", "bmi", "sex", "yada"),
  ...
  kable(longtable=T,
        caption="Table 1: Phylloquinone Supplementation Trial Population Description")
```
...
```{r responder-baseline-overlap-with-combp, fig.cap="Figure 2: Responder/baseline overlap"}
